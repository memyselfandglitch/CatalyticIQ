...
dataset_args['co2_methanol'] = {
    ...
    'time': 'temperature_c',
    'condition_dict': {
        # Must keep condition dim compatible with ORD pretrained checkpoint:
        # one continuous condition (len(list)+1 = 7) + time scalar (1) => cond_dim = 8.
